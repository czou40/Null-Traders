...
public class CharacterSheetScreen extends GameScreen {
    ...
    public Pane constructContentPane() {
        ...
        fighterPointBar.prefWidthProperty().bind(getPrimaryStage().widthProperty().multiply(
                0.75).subtract(15));
        ...
        pilotPointBar.prefWidthProperty().bind(getPrimaryStage().widthProperty().multiply(
                0.75).subtract(15));
        ...
        MyProgressBar merchantPointBar = new MyProgressBar(player.getMerchant(),
                startingSkillPoints);
        merchantPointBar.prefWidthProperty().bind(getPrimaryStage().widthProperty().multiply(
                0.75).subtract(15));
        ...
        MyProgressBar engineerPointBar = new MyProgressBar(player.getEngineer(),
                startingSkillPoints);
        engineerPointBar.prefWidthProperty().bind(getPrimaryStage().widthProperty().multiply(
                0.75).subtract(15));
