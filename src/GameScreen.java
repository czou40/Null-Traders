...
public abstract class GameScreen extends Screen {
    ...
    private MyGridPane constructSideBarPane() {
        ...
        MyGridPane sideBarPane = new MyGridPane(new double[]{10,10,10,10,10}, new double[]{100});

        //characterImageView.fitHeightProperty().bind(getPrimaryStage().heightProperty().multiply(0.1));
