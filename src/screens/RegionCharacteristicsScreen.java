...
public class RegionCharacteristicsScreen extends GameScreen {
    ...
    public Pane constructContentPane() {
        ...
        MyGridPane contentGridPane = new MyGridPane(null,
                new double[]{30, 70});
        ...
        contentGridPane.addColumn(80, 0, nameLeftLabel, descriptionLeftLabel,
                techLevelLeftLabel, marketplaceLeftLabel, itemsLeftLabel);
        contentGridPane.addColumn(80, 1, nameRightLabel, descriptionRightLabel,
